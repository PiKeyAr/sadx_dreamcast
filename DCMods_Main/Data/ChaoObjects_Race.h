...
NJS_MESHSET_SADX meshlist_0014AE90[] = {
	{ NJD_MESHSET_TRIMESH | 0, 11, polyCR_0014AC14, NULL, NULL, NULL, uv_0014ACF8, NULL }
};
...
NJS_MESHSET_SADX meshlist_000462C4[] = {
	{ NJD_MESHSET_TRIMESH | 0, 1, polyCR_0004629C, NULL, NULL, NULL, uv_000462AC, NULL }
};
...
NJS_MESHSET_SADX meshlist_00045C34[] = {
	{ NJD_MESHSET_TRIMESH | 0, 20, polyCR_00045A2C, NULL, NULL, NULL, uv_00045AF4, NULL }
};
...
Sint16 polyCR_0004481A[] = {
	4, 111, 110, 109, 108
};

Sint16 polyCR_00044824[] = {
	4, 115, 114, 113, 112
};

Sint16 polyCR_0004482E[] = {
	4, 119, 118, 117, 116
};

Sint16 polyCR_00044838[] = {
	4, 123, 122, 121, 120
};

Sint16 polyCR_00044842[] = {
	4, 127, 126, 125, 124
};

Sint16 polyCR_0004484C[] = {
	4, 131, 130, 129, 128
};

Sint16 polyCR_00044856[] = {
	4, 135, 134, 133, 132
};

Sint16 polyCR_00044860[] = {
	4, 139, 138, 137, 136
};
...
NJS_MESHSET_SADX meshlist_00044BC4[] = {
	{ NJD_MESHSET_TRIMESH | 0, 19, polyCR_00044688, NULL, NULL, NULL, uv_0004486C, NULL },
{ NJD_MESHSET_TRIMESH | 1, 1, polyCR_0004481A, NULL, NULL, NULL, uvCR_00044B44, NULL },
{ NJD_MESHSET_TRIMESH | 2, 1, polyCR_00044824, NULL, NULL, NULL, uv_00044B54, NULL },
{ NJD_MESHSET_TRIMESH | 3, 1, polyCR_0004482E, NULL, NULL, NULL, uv_00044B64, NULL },
{ NJD_MESHSET_TRIMESH | 4, 1, polyCR_00044838, NULL, NULL, NULL, uv_00044B74, NULL },
{ NJD_MESHSET_TRIMESH | 5, 1, polyCR_00044842, NULL, NULL, NULL, uv_00044B84, NULL },
{ NJD_MESHSET_TRIMESH | 6, 1, polyCR_0004484C, NULL, NULL, NULL, uv_00044B94, NULL },
{ NJD_MESHSET_TRIMESH | 7, 1, polyCR_00044856, NULL, NULL, NULL, uv_00044BA4, NULL },
{ NJD_MESHSET_TRIMESH | 8, 1, polyCR_00044860, NULL, NULL, NULL, uv_00044BB4, NULL }
};
