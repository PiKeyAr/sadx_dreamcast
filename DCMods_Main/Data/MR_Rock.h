...
NJS_MATERIAL matlistADV02_001E8530[] = {
	{ { 0xFFFFFFFF },{ 0xFFFFFFFF }, 11, MROBJTexName_mra_256s_eikaba, NJD_D_100 | NJD_FILTER_BILINEAR | NJD_FLAG_CLAMP_U | NJD_FLAG_IGNORE_SPECULAR | NJD_FLAG_USE_TEXTURE | NJD_DA_INV_SRC | NJD_SA_SRC }
};
